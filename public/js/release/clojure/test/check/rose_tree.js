...
clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__7015__auto__,writer__7016__auto__,opt__7017__auto__){
return cljs.core._write(writer__7016__auto__,"clojure.test.check.rose-tree/RoseTree");
});
...
return cljs.core.cons(cljs.core.first(s),clojure$test$check$rose_tree$exclude_nth((n - (1)),cljs.core.rest(s)));
}
} else {
return null;
}
...
return clojure.test.check.rose_tree.make_rose((function (){var G__9607 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__9607) : f.call(null,G__9607));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9605_SHARP_){
return clojure$test$check$rose_tree$fmap(f,p1__9605_SHARP_);
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9608_SHARP_){
return clojure$test$check$rose_tree$filter(pred,p1__9608_SHARP_);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__9609_SHARP_){
var G__9611 = clojure.test.check.rose_tree.root(p1__9609_SHARP_);
...
var iter__7189__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__9629(s__9630){
return (new cljs.core.LazySeq(null,(function (){
var s__9630__$1 = s__9630;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__9630__$1);
if(temp__4657__auto__){
var xs__5205__auto__ = temp__4657__auto__;
var vec__9641 = cljs.core.first(xs__5205__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9641,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9641,(1),null);
var iterys__7185__auto__ = ((function (s__9630__$1,vec__9641,rose,index,xs__5205__auto__,temp__4657__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__9629_$_iter__9631(s__9632){
return (new cljs.core.LazySeq(null,((function (s__9630__$1,vec__9641,rose,index,xs__5205__auto__,temp__4657__auto__){
return (function (){
var s__9632__$1 = s__9632;
while(true){
var temp__4657__auto____$1 = cljs.core.seq(s__9632__$1);
if(temp__4657__auto____$1){
var s__9632__$2 = temp__4657__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__9632__$2)){
var c__7187__auto__ = cljs.core.chunk_first(s__9632__$2);
var size__7188__auto__ = cljs.core.count(c__7187__auto__);
var b__9634 = cljs.core.chunk_buffer(size__7188__auto__);
if((function (){var i__9633 = (0);
while(true){
if((i__9633 < size__7188__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7187__auto__,i__9633);
cljs.core.chunk_append(b__9634,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__9634),clojure$test$check$rose_tree$permutations_$_iter__9629_$_iter__9631(cljs.core.chunk_rest(s__9632__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__9634),null);
}
} else {
var child = cljs.core.first(s__9632__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__9629_$_iter__9631(cljs.core.rest(s__9632__$2)));
}
} else {
return null;
}
...
});})(s__9630__$1,vec__9641,rose,index,xs__5205__auto__,temp__4657__auto__))
,null,null));
});})(s__9630__$1,vec__9641,rose,index,xs__5205__auto__,temp__4657__auto__))
;
var fs__7186__auto__ = cljs.core.seq(iterys__7185__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__7186__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__7186__auto__,clojure$test$check$rose_tree$permutations_$_iter__9629(cljs.core.rest(s__9630__$1)));
} else {
var G__9647 = cljs.core.rest(s__9630__$1);
s__9630__$1 = G__9647;
continue;
}
} else {
...
return iter__7189__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9648_SHARP_){
return clojure$test$check$rose_tree$zip(f,p1__9648_SHARP_);
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9649_SHARP_){
return clojure$test$check$rose_tree$shrink(f,p1__9649_SHARP_);
...
var temp__4655__auto__ = cljs.core.seq(children);
...
return cljs.core.cons(node,((cljs.core.seq(the_children))?clojure$test$check$rose_tree$seq_$_helper(cljs.core.first(the_children),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node),clojure.test.check.rose_tree.make_stack(cljs.core.rest(the_children),stack)):(function (){var temp__4657__auto__ = cljs.core.seq(stack);
if(temp__4657__auto__){
var s = temp__4657__auto__;
...
var temp__4657__auto__ = cljs.core.seq(stack);
if(temp__4657__auto__){
var s = temp__4657__auto__;
var f = cljs.core.ffirst(s);
var r = cljs.core.rest(cljs.core.first(s));
