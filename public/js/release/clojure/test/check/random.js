...
var x__7072__auto__ = (((rng == null))?null:rng);
var m__7073__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__7072__auto__)]);
if(!((m__7073__auto__ == null))){
return (m__7073__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto__.call(null,rng));
} else {
var m__7073__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__7073__auto____$1 == null))){
return (m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto____$1.call(null,rng));
} else {
...
var x__7072__auto__ = (((rng == null))?null:rng);
var m__7073__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__7072__auto__)]);
if(!((m__7073__auto__ == null))){
return (m__7073__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto__.call(null,rng));
} else {
var m__7073__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__7073__auto____$1 == null))){
return (m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto____$1.call(null,rng));
} else {
...
var x__7072__auto__ = (((rng == null))?null:rng);
var m__7073__auto__ = (clojure.test.check.random.split[goog.typeOf(x__7072__auto__)]);
if(!((m__7073__auto__ == null))){
return (m__7073__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto__.call(null,rng));
} else {
var m__7073__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__7073__auto____$1 == null))){
return (m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7073__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7073__auto____$1.call(null,rng));
} else {
...
var x__7072__auto__ = (((rng == null))?null:rng);
var m__7073__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__7072__auto__)]);
if(!((m__7073__auto__ == null))){
return (m__7073__auto__.cljs$core$IFn$_invoke$arity$2 ? m__7073__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__7073__auto__.call(null,rng,n));
} else {
var m__7073__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__7073__auto____$1 == null))){
return (m__7073__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__7073__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__7073__auto____$1.call(null,rng,n));
} else {
...
var G__9742 = z;
if(((24) > (function (){var G__9743 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__9743) : clojure.test.check.random.longs.bit_count.call(null,G__9743));
})())){
return clojure.test.check.random.longs.bit_xor(G__9742,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__9742;
}
});
...
var G__9746 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__9747 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__9746;
ret = G__9747;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__7015__auto__,writer__7016__auto__,opt__7017__auto__){
return cljs.core._write(writer__7016__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__6409__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__9748 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__9748) : cljs.core.atom.call(null,G__9748));
})();
return ((function (a){
return (function (){
...
var map__9750__$1 = ((((!((map__9750 == null)))?((((map__9750.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9750.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9750):map__9750);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9750__$1,cljs.core.cst$kw$state);
var vec__9752 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9752,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9752,(1),null);
...
var args9755 = [];
var len__7484__auto___9758 = arguments.length;
var i__7485__auto___9759 = (0);
while(true){
if((i__7485__auto___9759 < len__7484__auto___9758)){
args9755.push((arguments[i__7485__auto___9759]));

var G__9760 = (i__7485__auto___9759 + (1));
i__7485__auto___9759 = G__9760;
continue;
} else {
}
break;
